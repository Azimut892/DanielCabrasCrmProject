...
namespace DataverseModel
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataverseModel.DACa_Expenditure"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataverseModel.DACa_Expenditure> DACa_ExpenditureSet
		{
			get
			{
				return this.CreateQuery<DataverseModel.DACa_Expenditure>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataverseModel.DACa_Header"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataverseModel.DACa_Header> DACa_HeaderSet
		{
			get
			{
				return this.CreateQuery<DataverseModel.DACa_Header>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataverseModel.DACa_Line"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataverseModel.DACa_Line> DACa_LineSet
		{
			get
			{
				return this.CreateQuery<DataverseModel.DACa_Line>();
			}
		}
